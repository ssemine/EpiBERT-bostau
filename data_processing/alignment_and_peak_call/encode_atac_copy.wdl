...
workflow atac {
	...
	scatter(i in range(num_rep)) {
		...
		Boolean has_input_of_macs2_signal_track = false
	...
	Boolean has_input_of_macs2_signal_track_pooled = false #defined(pool_ta.ta_pooled)
	...
	output {
        ...
        Array[File]? overlap_peaks_pr = overlap_pr.bfilt_overlap_peak
        Array[File]? idr_peaks_pr = idr_pr.bfilt_idr_peak
